...
class EmployeeView:
    ...
    def add_employee(self):
        if self.txtName.get() == "" or self.txtAge.get() == "" or self.txtDob.get() == "" or self.txtEmail.get() == "" or self.comboGender.get() == "" or self.txtContact.get() == "" or self.txtAddress.get(1.0, END) == "":
